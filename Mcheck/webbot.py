""" Not my code. It is the library 'webbot' that I slightly modified for the sake of the app"""
...
class Browser:
    ...
    **Constructor**
    ...
    def __init__(self, showWindow=True, custom=-1):
        ...
        # print('drivers{0}{1}'.format(os.path.sep , driverfilename))
        # print(driverpath)
        if custom == -1:
            driverpath = 'C:/Users/xavie/Anaconda3/Lib/site-packages/webbot/drivers/chrome_windows.exe'

        elif custom == 0:
            driverpath = 'drivers/chrome_windows.exe'
            ...
            if sys.platform == 'linux' or sys.platform == 'linux2':
                driverpath = 'Mcheck/drivers/chrome_linux'
            elif sys.platform == 'win32':
                driverpath = 'Mcheck/drivers/chrome_windows.exe'
            elif sys.platform == 'darwin':
                driverpath = 'Mcheck/drivers/cchrome_mac'
    ...
    def find_elements(self, text='', tag='button', id='', classname='', number=1, css_selector='', xpath='',
                      loose_match=True):
